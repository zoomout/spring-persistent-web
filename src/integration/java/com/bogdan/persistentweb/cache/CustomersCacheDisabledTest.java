...
class CustomersCacheDisabledTest {
  ...
  @Test
  void shouldGetUpdatedCustomerAfterUpdate_whenCacheIsDisabled() throws Exception {
    ...
    // Then the response has the updated customer because cache is disabled
    resultActions
